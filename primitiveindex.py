...
class PrimitiveIndex(AbstractIndex):
    """ A primitive index using binary search"""
    ...
    def searchExact(self, key):
        ...
        # TODO: Implement this using a binary search of the sorted list self.keys
        ...
        # e.g. line 56: indexClass = PrimitiveIndex
